...
COMMAND_NONLOGIN_SHELL_ECHO_COMMAND: tuple[str, ...] = (
    "sh",
    "-c",
    "printf '42\\n'",
)
COMMAND_ECHO_STDOUT = "42\n"
COMMAND_NONLOGIN_SHELL_ECHO_BENCHMARK_SEMANTICS = "shell-command-echo-v2"
