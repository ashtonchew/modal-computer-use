...
With screenshots and clicks down in the tens of milliseconds, the shell-command endpoint started to look wrong. Its median was 56 ms and its p95 was 249 ms. A tail that far above the median usually means something is waiting in line.
...
Across ten samples per arm, the private loop measured 9.9 ms p50 and 10.6 ms p95.
