...
With screenshots and clicks down in the tens of milliseconds, the shell-command endpoint started to look wrong. Its median was 55 ms and its p95 was 220 ms. Two samples out of thirty carried that tail. Something was queueing.
