...
![An async owner provisions once, then a Modal Function borrows one connection for the repeated computer-use loop](../assets/modal-optimized-agent-loop.svg)
